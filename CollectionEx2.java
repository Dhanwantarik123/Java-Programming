...
public class CollectionEx2{
	public void demoCollections(){
		...
		System.out.println("Printing the value of key :");
		System.out.println(rollList.get(1002));
		System.out.println("Printing the elements of map :");
		for(Map.Entry<Integer,String>entry:rollList.entrySet()){
